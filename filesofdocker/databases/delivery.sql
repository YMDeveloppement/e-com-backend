...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 21 août 2026 à 17:30
...
(4, '2026_07_05_150244_create_deliveries_table', 1),
(5, '2026_07_05_150913_create_personal_access_tokens_table', 1);
...
ALTER TABLE `deliveries`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `deliveries_order_uuid_unique` (`order_uuid`),
